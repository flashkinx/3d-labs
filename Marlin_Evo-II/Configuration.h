...
#define CUSTOM_MACHINE_NAME "3D LABS II"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4000, 89 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.65 //-0.45   // Z offset: -below +above  [the nozzle]
