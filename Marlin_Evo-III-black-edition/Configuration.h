...
#define CUSTOM_MACHINE_NAME "3D LABS Black"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100*2, 100*2, 4000, 89 } // *2 bei DRV Treibern mit 1/32 Steps
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100*2, 100*2, 4000, 200*16*3/(7.3*3.1415)} // *2 bei DRV Treibern mit 1/32 Steps
//200*16*3/(7.3*3.1415) = 418.6 //Motor Steps * Micro-stepping * Gear Ratio / (Hobb Diameter * Pi)
// Für den Titan Extruder
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER 0 //-0.65 //-0.45   // Z offset: -below +above  [the nozzle]
